let FrenchBigneyList = [];

const url = "../JSON/french_bigney.json";
let results = null;
...
const output = (people) => {
    people.forEach(
        person => {
            ...
            document.querySelector('#frenchpeople').appendChild(article);
        }
    );
}

const reset = () => {
    document.querySelector('#frenchpeople').innerHTML = '';
}
